...
impl<'a> SRAM_PEF_W<'a> {
    ...
    #[inline(always)]
    pub fn variant(self, variant: SRAM_PEF_A) -> &'a mut W {
        {
    ...
    pub fn no_parity_error(self) -> &'a mut W {
        self.variant(SRAM_PEF_A::NOPARITYERROR)
    }
    #[doc = "SRAM parity error detected"]
    #[inline(always)]
    pub fn parity_error_detected(self) -> &'a mut W {
        self.variant(SRAM_PEF_A::PARITYERRORDETECTED)
    }
