#[doc = "Reader of register LUT626L"]
pub type R = crate::R<u32, super::LUT626L>;
#[doc = "Writer for register LUT626L"]
pub type W = crate::W<u32, super::LUT626L>;
#[doc = "Register LUT626L `reset()`'s with value 0"]
impl crate::ResetValue for super::LUT626L {
    type Type = u32;
    #[inline(always)]
