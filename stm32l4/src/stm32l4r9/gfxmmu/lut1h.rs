#[doc = "Reader of register LUT1H"]
pub type R = crate::R<u32, super::LUT1H>;
#[doc = "Writer for register LUT1H"]
pub type W = crate::W<u32, super::LUT1H>;
#[doc = "Register LUT1H `reset()`'s with value 0"]
impl crate::ResetValue for super::LUT1H {
    type Type = u32;
    #[inline(always)]
