#[doc = "Reader of register LUT250L"]
pub type R = crate::R<u32, super::LUT250L>;
#[doc = "Writer for register LUT250L"]
pub type W = crate::W<u32, super::LUT250L>;
#[doc = "Register LUT250L `reset()`'s with value 0"]
impl crate::ResetValue for super::LUT250L {
    type Type = u32;
    #[inline(always)]
