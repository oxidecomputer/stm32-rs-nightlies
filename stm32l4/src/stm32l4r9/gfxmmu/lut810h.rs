#[doc = "Reader of register LUT810H"]
pub type R = crate::R<u32, super::LUT810H>;
#[doc = "Writer for register LUT810H"]
pub type W = crate::W<u32, super::LUT810H>;
#[doc = "Register LUT810H `reset()`'s with value 0"]
impl crate::ResetValue for super::LUT810H {
    type Type = u32;
    #[inline(always)]
