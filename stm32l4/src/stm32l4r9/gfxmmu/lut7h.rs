#[doc = "Reader of register LUT7H"]
pub type R = crate::R<u32, super::LUT7H>;
#[doc = "Writer for register LUT7H"]
pub type W = crate::W<u32, super::LUT7H>;
#[doc = "Register LUT7H `reset()`'s with value 0"]
impl crate::ResetValue for super::LUT7H {
    type Type = u32;
    #[inline(always)]
