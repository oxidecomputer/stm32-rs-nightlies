#[doc = "Reader of register LUT729H"]
pub type R = crate::R<u32, super::LUT729H>;
#[doc = "Writer for register LUT729H"]
pub type W = crate::W<u32, super::LUT729H>;
#[doc = "Register LUT729H `reset()`'s with value 0"]
impl crate::ResetValue for super::LUT729H {
    type Type = u32;
    #[inline(always)]
