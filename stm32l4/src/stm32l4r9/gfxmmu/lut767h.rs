#[doc = "Reader of register LUT767H"]
pub type R = crate::R<u32, super::LUT767H>;
#[doc = "Writer for register LUT767H"]
pub type W = crate::W<u32, super::LUT767H>;
#[doc = "Register LUT767H `reset()`'s with value 0"]
impl crate::ResetValue for super::LUT767H {
    type Type = u32;
    #[inline(always)]
