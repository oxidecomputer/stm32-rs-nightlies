#[doc = "Reader of register LUT390H"]
pub type R = crate::R<u32, super::LUT390H>;
#[doc = "Writer for register LUT390H"]
pub type W = crate::W<u32, super::LUT390H>;
#[doc = "Register LUT390H `reset()`'s with value 0"]
impl crate::ResetValue for super::LUT390H {
    type Type = u32;
    #[inline(always)]
