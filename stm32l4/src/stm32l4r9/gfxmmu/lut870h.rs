#[doc = "Reader of register LUT870H"]
pub type R = crate::R<u32, super::LUT870H>;
#[doc = "Writer for register LUT870H"]
pub type W = crate::W<u32, super::LUT870H>;
#[doc = "Register LUT870H `reset()`'s with value 0"]
impl crate::ResetValue for super::LUT870H {
    type Type = u32;
    #[inline(always)]
