#[doc = "Reader of register LUT570H"]
pub type R = crate::R<u32, super::LUT570H>;
#[doc = "Writer for register LUT570H"]
pub type W = crate::W<u32, super::LUT570H>;
#[doc = "Register LUT570H `reset()`'s with value 0"]
impl crate::ResetValue for super::LUT570H {
    type Type = u32;
    #[inline(always)]
