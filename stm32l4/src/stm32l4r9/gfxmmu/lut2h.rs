#[doc = "Reader of register LUT2H"]
pub type R = crate::R<u32, super::LUT2H>;
#[doc = "Writer for register LUT2H"]
pub type W = crate::W<u32, super::LUT2H>;
#[doc = "Register LUT2H `reset()`'s with value 0"]
impl crate::ResetValue for super::LUT2H {
    type Type = u32;
    #[inline(always)]
