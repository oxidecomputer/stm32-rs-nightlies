#[doc = "Reader of register LUT839H"]
pub type R = crate::R<u32, super::LUT839H>;
#[doc = "Writer for register LUT839H"]
pub type W = crate::W<u32, super::LUT839H>;
#[doc = "Register LUT839H `reset()`'s with value 0"]
impl crate::ResetValue for super::LUT839H {
    type Type = u32;
    #[inline(always)]
