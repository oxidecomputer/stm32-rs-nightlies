#[doc = "Reader of register LUT365L"]
pub type R = crate::R<u32, super::LUT365L>;
#[doc = "Writer for register LUT365L"]
pub type W = crate::W<u32, super::LUT365L>;
#[doc = "Register LUT365L `reset()`'s with value 0"]
impl crate::ResetValue for super::LUT365L {
    type Type = u32;
    #[inline(always)]
