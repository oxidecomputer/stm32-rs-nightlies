#[doc = "Reader of register LUT643L"]
pub type R = crate::R<u32, super::LUT643L>;
#[doc = "Writer for register LUT643L"]
pub type W = crate::W<u32, super::LUT643L>;
#[doc = "Register LUT643L `reset()`'s with value 0"]
impl crate::ResetValue for super::LUT643L {
    type Type = u32;
    #[inline(always)]
