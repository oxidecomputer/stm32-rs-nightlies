#[doc = "Reader of register LUT782H"]
pub type R = crate::R<u32, super::LUT782H>;
#[doc = "Writer for register LUT782H"]
pub type W = crate::W<u32, super::LUT782H>;
#[doc = "Register LUT782H `reset()`'s with value 0"]
impl crate::ResetValue for super::LUT782H {
    type Type = u32;
    #[inline(always)]
