#[doc = "Reader of register LUT13H"]
pub type R = crate::R<u32, super::LUT13H>;
#[doc = "Writer for register LUT13H"]
pub type W = crate::W<u32, super::LUT13H>;
#[doc = "Register LUT13H `reset()`'s with value 0"]
impl crate::ResetValue for super::LUT13H {
    type Type = u32;
    #[inline(always)]
