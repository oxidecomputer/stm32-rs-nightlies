#[doc = "Reader of register LUT870L"]
pub type R = crate::R<u32, super::LUT870L>;
#[doc = "Writer for register LUT870L"]
pub type W = crate::W<u32, super::LUT870L>;
#[doc = "Register LUT870L `reset()`'s with value 0"]
impl crate::ResetValue for super::LUT870L {
    type Type = u32;
    #[inline(always)]
