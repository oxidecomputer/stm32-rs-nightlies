#[doc = "Reader of register LUT333L"]
pub type R = crate::R<u32, super::LUT333L>;
#[doc = "Writer for register LUT333L"]
pub type W = crate::W<u32, super::LUT333L>;
#[doc = "Register LUT333L `reset()`'s with value 0"]
impl crate::ResetValue for super::LUT333L {
    type Type = u32;
    #[inline(always)]
