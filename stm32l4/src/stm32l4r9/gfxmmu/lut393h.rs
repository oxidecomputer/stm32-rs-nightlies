#[doc = "Reader of register LUT393H"]
pub type R = crate::R<u32, super::LUT393H>;
#[doc = "Writer for register LUT393H"]
pub type W = crate::W<u32, super::LUT393H>;
#[doc = "Register LUT393H `reset()`'s with value 0"]
impl crate::ResetValue for super::LUT393H {
    type Type = u32;
    #[inline(always)]
