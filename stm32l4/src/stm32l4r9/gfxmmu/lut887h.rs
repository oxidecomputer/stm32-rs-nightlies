#[doc = "Reader of register LUT887H"]
pub type R = crate::R<u32, super::LUT887H>;
#[doc = "Writer for register LUT887H"]
pub type W = crate::W<u32, super::LUT887H>;
#[doc = "Register LUT887H `reset()`'s with value 0"]
impl crate::ResetValue for super::LUT887H {
    type Type = u32;
    #[inline(always)]
