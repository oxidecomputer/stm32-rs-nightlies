#[doc = "Reader of register LUT182L"]
pub type R = crate::R<u32, super::LUT182L>;
#[doc = "Writer for register LUT182L"]
pub type W = crate::W<u32, super::LUT182L>;
#[doc = "Register LUT182L `reset()`'s with value 0"]
impl crate::ResetValue for super::LUT182L {
    type Type = u32;
    #[inline(always)]
