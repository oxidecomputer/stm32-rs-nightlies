#[doc = "Reader of register LUT255H"]
pub type R = crate::R<u32, super::LUT255H>;
#[doc = "Writer for register LUT255H"]
pub type W = crate::W<u32, super::LUT255H>;
#[doc = "Register LUT255H `reset()`'s with value 0"]
impl crate::ResetValue for super::LUT255H {
    type Type = u32;
    #[inline(always)]
