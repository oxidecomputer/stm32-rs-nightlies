#[doc = "Reader of register LUT366L"]
pub type R = crate::R<u32, super::LUT366L>;
#[doc = "Writer for register LUT366L"]
pub type W = crate::W<u32, super::LUT366L>;
#[doc = "Register LUT366L `reset()`'s with value 0"]
impl crate::ResetValue for super::LUT366L {
    type Type = u32;
    #[inline(always)]
