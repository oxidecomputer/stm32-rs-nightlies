#[doc = "Reader of register LUT365H"]
pub type R = crate::R<u32, super::LUT365H>;
#[doc = "Writer for register LUT365H"]
pub type W = crate::W<u32, super::LUT365H>;
#[doc = "Register LUT365H `reset()`'s with value 0"]
impl crate::ResetValue for super::LUT365H {
    type Type = u32;
    #[inline(always)]
