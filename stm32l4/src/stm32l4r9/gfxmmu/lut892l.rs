#[doc = "Reader of register LUT892L"]
pub type R = crate::R<u32, super::LUT892L>;
#[doc = "Writer for register LUT892L"]
pub type W = crate::W<u32, super::LUT892L>;
#[doc = "Register LUT892L `reset()`'s with value 0"]
impl crate::ResetValue for super::LUT892L {
    type Type = u32;
    #[inline(always)]
