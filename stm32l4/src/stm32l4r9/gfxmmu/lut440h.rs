#[doc = "Reader of register LUT440H"]
pub type R = crate::R<u32, super::LUT440H>;
#[doc = "Writer for register LUT440H"]
pub type W = crate::W<u32, super::LUT440H>;
#[doc = "Register LUT440H `reset()`'s with value 0"]
impl crate::ResetValue for super::LUT440H {
    type Type = u32;
    #[inline(always)]
