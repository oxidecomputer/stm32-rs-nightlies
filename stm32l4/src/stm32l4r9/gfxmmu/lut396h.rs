#[doc = "Reader of register LUT396H"]
pub type R = crate::R<u32, super::LUT396H>;
#[doc = "Writer for register LUT396H"]
pub type W = crate::W<u32, super::LUT396H>;
#[doc = "Register LUT396H `reset()`'s with value 0"]
impl crate::ResetValue for super::LUT396H {
    type Type = u32;
    #[inline(always)]
