#[doc = "Reader of register LUT645H"]
pub type R = crate::R<u32, super::LUT645H>;
#[doc = "Writer for register LUT645H"]
pub type W = crate::W<u32, super::LUT645H>;
#[doc = "Register LUT645H `reset()`'s with value 0"]
impl crate::ResetValue for super::LUT645H {
    type Type = u32;
    #[inline(always)]
