#[doc = "Reader of register LUT838L"]
pub type R = crate::R<u32, super::LUT838L>;
#[doc = "Writer for register LUT838L"]
pub type W = crate::W<u32, super::LUT838L>;
#[doc = "Register LUT838L `reset()`'s with value 0"]
impl crate::ResetValue for super::LUT838L {
    type Type = u32;
    #[inline(always)]
