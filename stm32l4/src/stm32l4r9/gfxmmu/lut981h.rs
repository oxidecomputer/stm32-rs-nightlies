#[doc = "Reader of register LUT981H"]
pub type R = crate::R<u32, super::LUT981H>;
#[doc = "Writer for register LUT981H"]
pub type W = crate::W<u32, super::LUT981H>;
#[doc = "Register LUT981H `reset()`'s with value 0"]
impl crate::ResetValue for super::LUT981H {
    type Type = u32;
    #[inline(always)]
