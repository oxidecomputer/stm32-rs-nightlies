#[doc = "Reader of register LUT418L"]
pub type R = crate::R<u32, super::LUT418L>;
#[doc = "Writer for register LUT418L"]
pub type W = crate::W<u32, super::LUT418L>;
#[doc = "Register LUT418L `reset()`'s with value 0"]
impl crate::ResetValue for super::LUT418L {
    type Type = u32;
    #[inline(always)]
