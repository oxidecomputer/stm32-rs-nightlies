#[doc = "Reader of register LUT726H"]
pub type R = crate::R<u32, super::LUT726H>;
#[doc = "Writer for register LUT726H"]
pub type W = crate::W<u32, super::LUT726H>;
#[doc = "Register LUT726H `reset()`'s with value 0"]
impl crate::ResetValue for super::LUT726H {
    type Type = u32;
    #[inline(always)]
