#[doc = "Reader of register LUT432L"]
pub type R = crate::R<u32, super::LUT432L>;
#[doc = "Writer for register LUT432L"]
pub type W = crate::W<u32, super::LUT432L>;
#[doc = "Register LUT432L `reset()`'s with value 0"]
impl crate::ResetValue for super::LUT432L {
    type Type = u32;
    #[inline(always)]
