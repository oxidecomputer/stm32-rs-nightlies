#[doc = "Reader of register LUT476L"]
pub type R = crate::R<u32, super::LUT476L>;
#[doc = "Writer for register LUT476L"]
pub type W = crate::W<u32, super::LUT476L>;
#[doc = "Register LUT476L `reset()`'s with value 0"]
impl crate::ResetValue for super::LUT476L {
    type Type = u32;
    #[inline(always)]
