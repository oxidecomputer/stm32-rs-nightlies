#[doc = "Reader of register LUT702L"]
pub type R = crate::R<u32, super::LUT702L>;
#[doc = "Writer for register LUT702L"]
pub type W = crate::W<u32, super::LUT702L>;
#[doc = "Register LUT702L `reset()`'s with value 0"]
impl crate::ResetValue for super::LUT702L {
    type Type = u32;
    #[inline(always)]
