#[doc = "Reader of register LUT611L"]
pub type R = crate::R<u32, super::LUT611L>;
#[doc = "Writer for register LUT611L"]
pub type W = crate::W<u32, super::LUT611L>;
#[doc = "Register LUT611L `reset()`'s with value 0"]
impl crate::ResetValue for super::LUT611L {
    type Type = u32;
    #[inline(always)]
