#[doc = "Reader of register LUT766L"]
pub type R = crate::R<u32, super::LUT766L>;
#[doc = "Writer for register LUT766L"]
pub type W = crate::W<u32, super::LUT766L>;
#[doc = "Register LUT766L `reset()`'s with value 0"]
impl crate::ResetValue for super::LUT766L {
    type Type = u32;
    #[inline(always)]
