#[doc = "Reader of register LUT9H"]
pub type R = crate::R<u32, super::LUT9H>;
#[doc = "Writer for register LUT9H"]
pub type W = crate::W<u32, super::LUT9H>;
#[doc = "Register LUT9H `reset()`'s with value 0"]
impl crate::ResetValue for super::LUT9H {
    type Type = u32;
    #[inline(always)]
