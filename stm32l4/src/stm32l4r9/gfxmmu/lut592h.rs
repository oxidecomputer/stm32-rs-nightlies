#[doc = "Reader of register LUT592H"]
pub type R = crate::R<u32, super::LUT592H>;
#[doc = "Writer for register LUT592H"]
pub type W = crate::W<u32, super::LUT592H>;
#[doc = "Register LUT592H `reset()`'s with value 0"]
impl crate::ResetValue for super::LUT592H {
    type Type = u32;
    #[inline(always)]
