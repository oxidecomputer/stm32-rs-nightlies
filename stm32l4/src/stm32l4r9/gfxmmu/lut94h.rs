#[doc = "Reader of register LUT94H"]
pub type R = crate::R<u32, super::LUT94H>;
#[doc = "Writer for register LUT94H"]
pub type W = crate::W<u32, super::LUT94H>;
#[doc = "Register LUT94H `reset()`'s with value 0"]
impl crate::ResetValue for super::LUT94H {
    type Type = u32;
    #[inline(always)]
