#[doc = "Reader of register LUT659L"]
pub type R = crate::R<u32, super::LUT659L>;
#[doc = "Writer for register LUT659L"]
pub type W = crate::W<u32, super::LUT659L>;
#[doc = "Register LUT659L `reset()`'s with value 0"]
impl crate::ResetValue for super::LUT659L {
    type Type = u32;
    #[inline(always)]
