#[doc = "Reader of register LUT525L"]
pub type R = crate::R<u32, super::LUT525L>;
#[doc = "Writer for register LUT525L"]
pub type W = crate::W<u32, super::LUT525L>;
#[doc = "Register LUT525L `reset()`'s with value 0"]
impl crate::ResetValue for super::LUT525L {
    type Type = u32;
    #[inline(always)]
