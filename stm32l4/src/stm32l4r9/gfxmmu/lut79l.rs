#[doc = "Reader of register LUT79L"]
pub type R = crate::R<u32, super::LUT79L>;
#[doc = "Writer for register LUT79L"]
pub type W = crate::W<u32, super::LUT79L>;
#[doc = "Register LUT79L `reset()`'s with value 0"]
impl crate::ResetValue for super::LUT79L {
    type Type = u32;
    #[inline(always)]
