#[doc = "Reader of register LUT8H"]
pub type R = crate::R<u32, super::LUT8H>;
#[doc = "Writer for register LUT8H"]
pub type W = crate::W<u32, super::LUT8H>;
#[doc = "Register LUT8H `reset()`'s with value 0"]
impl crate::ResetValue for super::LUT8H {
    type Type = u32;
    #[inline(always)]
