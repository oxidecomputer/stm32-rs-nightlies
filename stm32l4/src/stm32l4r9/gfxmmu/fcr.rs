...
#[doc = "Write proxy for field `CB0OF`"]
...
#[doc = "Write proxy for field `CB1OF`"]
...
#[doc = "Write proxy for field `CB2OF`"]
...
#[doc = "Write proxy for field `CB3OF`"]
...
#[doc = "Write proxy for field `CAMEF`"]
