#[doc = "Reader of register LUT4H"]
pub type R = crate::R<u32, super::LUT4H>;
#[doc = "Writer for register LUT4H"]
pub type W = crate::W<u32, super::LUT4H>;
#[doc = "Register LUT4H `reset()`'s with value 0"]
impl crate::ResetValue for super::LUT4H {
    type Type = u32;
    #[inline(always)]
