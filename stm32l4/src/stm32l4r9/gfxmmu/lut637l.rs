#[doc = "Reader of register LUT637L"]
pub type R = crate::R<u32, super::LUT637L>;
#[doc = "Writer for register LUT637L"]
pub type W = crate::W<u32, super::LUT637L>;
#[doc = "Register LUT637L `reset()`'s with value 0"]
impl crate::ResetValue for super::LUT637L {
    type Type = u32;
    #[inline(always)]
