#[doc = "Reader of register LUT533H"]
pub type R = crate::R<u32, super::LUT533H>;
#[doc = "Writer for register LUT533H"]
pub type W = crate::W<u32, super::LUT533H>;
#[doc = "Register LUT533H `reset()`'s with value 0"]
impl crate::ResetValue for super::LUT533H {
    type Type = u32;
    #[inline(always)]
