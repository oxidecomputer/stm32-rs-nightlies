#[doc = "Reader of register LUT641H"]
pub type R = crate::R<u32, super::LUT641H>;
#[doc = "Writer for register LUT641H"]
pub type W = crate::W<u32, super::LUT641H>;
#[doc = "Register LUT641H `reset()`'s with value 0"]
impl crate::ResetValue for super::LUT641H {
    type Type = u32;
    #[inline(always)]
