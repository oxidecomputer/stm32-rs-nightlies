#[doc = "Reader of register LUT429H"]
pub type R = crate::R<u32, super::LUT429H>;
#[doc = "Writer for register LUT429H"]
pub type W = crate::W<u32, super::LUT429H>;
#[doc = "Register LUT429H `reset()`'s with value 0"]
impl crate::ResetValue for super::LUT429H {
    type Type = u32;
    #[inline(always)]
