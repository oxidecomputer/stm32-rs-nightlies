#[doc = "Reader of register LUT919L"]
pub type R = crate::R<u32, super::LUT919L>;
#[doc = "Writer for register LUT919L"]
pub type W = crate::W<u32, super::LUT919L>;
#[doc = "Register LUT919L `reset()`'s with value 0"]
impl crate::ResetValue for super::LUT919L {
    type Type = u32;
    #[inline(always)]
