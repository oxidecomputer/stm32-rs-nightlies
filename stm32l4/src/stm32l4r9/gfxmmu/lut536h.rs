#[doc = "Reader of register LUT536H"]
pub type R = crate::R<u32, super::LUT536H>;
#[doc = "Writer for register LUT536H"]
pub type W = crate::W<u32, super::LUT536H>;
#[doc = "Register LUT536H `reset()`'s with value 0"]
impl crate::ResetValue for super::LUT536H {
    type Type = u32;
    #[inline(always)]
