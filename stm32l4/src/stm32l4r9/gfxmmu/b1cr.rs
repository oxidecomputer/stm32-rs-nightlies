#[doc = "Reader of register B1CR"]
pub type R = crate::R<u32, super::B1CR>;
#[doc = "Writer for register B1CR"]
pub type W = crate::W<u32, super::B1CR>;
#[doc = "Register B1CR `reset()`'s with value 0"]
impl crate::ResetValue for super::B1CR {
    type Type = u32;
    #[inline(always)]
