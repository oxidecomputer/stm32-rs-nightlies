#[doc = "Reader of register LUT639L"]
pub type R = crate::R<u32, super::LUT639L>;
#[doc = "Writer for register LUT639L"]
pub type W = crate::W<u32, super::LUT639L>;
#[doc = "Register LUT639L `reset()`'s with value 0"]
impl crate::ResetValue for super::LUT639L {
    type Type = u32;
    #[inline(always)]
