#[doc = "Reader of register LUT1000H"]
pub type R = crate::R<u32, super::LUT1000H>;
#[doc = "Writer for register LUT1000H"]
pub type W = crate::W<u32, super::LUT1000H>;
#[doc = "Register LUT1000H `reset()`'s with value 0"]
impl crate::ResetValue for super::LUT1000H {
    type Type = u32;
    #[inline(always)]
