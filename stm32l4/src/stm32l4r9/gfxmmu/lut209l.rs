#[doc = "Reader of register LUT209L"]
pub type R = crate::R<u32, super::LUT209L>;
#[doc = "Writer for register LUT209L"]
pub type W = crate::W<u32, super::LUT209L>;
#[doc = "Register LUT209L `reset()`'s with value 0"]
impl crate::ResetValue for super::LUT209L {
    type Type = u32;
    #[inline(always)]
