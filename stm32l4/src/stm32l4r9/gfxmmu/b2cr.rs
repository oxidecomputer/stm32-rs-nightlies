#[doc = "Reader of register B2CR"]
pub type R = crate::R<u32, super::B2CR>;
#[doc = "Writer for register B2CR"]
pub type W = crate::W<u32, super::B2CR>;
#[doc = "Register B2CR `reset()`'s with value 0"]
impl crate::ResetValue for super::B2CR {
    type Type = u32;
    #[inline(always)]
