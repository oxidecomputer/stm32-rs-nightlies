#[doc = "Reader of register B0CR"]
pub type R = crate::R<u32, super::B0CR>;
#[doc = "Writer for register B0CR"]
pub type W = crate::W<u32, super::B0CR>;
#[doc = "Register B0CR `reset()`'s with value 0"]
impl crate::ResetValue for super::B0CR {
    type Type = u32;
    #[inline(always)]
