#[doc = "Reader of register LUT5H"]
pub type R = crate::R<u32, super::LUT5H>;
#[doc = "Writer for register LUT5H"]
pub type W = crate::W<u32, super::LUT5H>;
#[doc = "Register LUT5H `reset()`'s with value 0"]
impl crate::ResetValue for super::LUT5H {
    type Type = u32;
    #[inline(always)]
