#[doc = "Reader of register LUT3H"]
pub type R = crate::R<u32, super::LUT3H>;
#[doc = "Writer for register LUT3H"]
pub type W = crate::W<u32, super::LUT3H>;
#[doc = "Register LUT3H `reset()`'s with value 0"]
impl crate::ResetValue for super::LUT3H {
    type Type = u32;
    #[inline(always)]
