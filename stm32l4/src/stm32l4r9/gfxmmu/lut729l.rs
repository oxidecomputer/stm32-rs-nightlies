#[doc = "Reader of register LUT729L"]
pub type R = crate::R<u32, super::LUT729L>;
#[doc = "Writer for register LUT729L"]
pub type W = crate::W<u32, super::LUT729L>;
#[doc = "Register LUT729L `reset()`'s with value 0"]
impl crate::ResetValue for super::LUT729L {
    type Type = u32;
    #[inline(always)]
