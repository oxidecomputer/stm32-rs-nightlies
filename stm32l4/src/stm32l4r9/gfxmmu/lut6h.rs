#[doc = "Reader of register LUT6H"]
pub type R = crate::R<u32, super::LUT6H>;
#[doc = "Writer for register LUT6H"]
pub type W = crate::W<u32, super::LUT6H>;
#[doc = "Register LUT6H `reset()`'s with value 0"]
impl crate::ResetValue for super::LUT6H {
    type Type = u32;
    #[inline(always)]
