#[doc = "Reader of register LUT422L"]
pub type R = crate::R<u32, super::LUT422L>;
#[doc = "Writer for register LUT422L"]
pub type W = crate::W<u32, super::LUT422L>;
#[doc = "Register LUT422L `reset()`'s with value 0"]
impl crate::ResetValue for super::LUT422L {
    type Type = u32;
    #[inline(always)]
