#[doc = "Reader of register LUT183L"]
pub type R = crate::R<u32, super::LUT183L>;
#[doc = "Writer for register LUT183L"]
pub type W = crate::W<u32, super::LUT183L>;
#[doc = "Register LUT183L `reset()`'s with value 0"]
impl crate::ResetValue for super::LUT183L {
    type Type = u32;
    #[inline(always)]
