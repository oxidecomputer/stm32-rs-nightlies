#[doc = "Reader of register LUT264L"]
pub type R = crate::R<u32, super::LUT264L>;
#[doc = "Writer for register LUT264L"]
pub type W = crate::W<u32, super::LUT264L>;
#[doc = "Register LUT264L `reset()`'s with value 0"]
impl crate::ResetValue for super::LUT264L {
    type Type = u32;
    #[inline(always)]
