#[doc = "Reader of register DFSDM_FLT1AWLTR"]
pub type R = crate::R<u32, super::DFSDM_FLT1AWLTR>;
#[doc = "Writer for register DFSDM_FLT1AWLTR"]
pub type W = crate::W<u32, super::DFSDM_FLT1AWLTR>;
#[doc = "Register DFSDM_FLT1AWLTR `reset()`'s with value 0"]
impl crate::ResetValue for super::DFSDM_FLT1AWLTR {
    type Type = u32;
    #[inline(always)]
