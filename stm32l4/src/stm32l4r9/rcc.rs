...
#[doc = "`read()` method returns [pllsai1cfgr::R](pllsai1cfgr::R) reader structure"]
impl crate::Readable for PLLSAI1CFGR {}
#[doc = "`write(|w| ..)` method takes [pllsai1cfgr::W](pllsai1cfgr::W) writer structure"]
...
#[doc = "`read()` method returns [pllsai2cfgr::R](pllsai2cfgr::R) reader structure"]
impl crate::Readable for PLLSAI2CFGR {}
#[doc = "`write(|w| ..)` method takes [pllsai2cfgr::W](pllsai2cfgr::W) writer structure"]
