...
#[doc = "Reader of field `TCDMAEN`"]
pub type TCDMAEN_R = crate::R<bool, bool>;
#[doc = "Write proxy for field `TCDMAEN`"]
pub struct TCDMAEN_W<'a> {
    w: &'a mut W,
}
impl<'a> TCDMAEN_W<'a> {
    #[doc = r"Sets the field bit"]
...
impl R {
    ...
    pub fn addre(&self) -> ADDRE_R {
        ADDRE_R::new(((self.bits >> 3) & 0x01) != 0)
    }
    #[doc = "Bit 4 - NACKIE"]
    #[inline(always)]
    ...
    pub fn tcdmaen(&self) -> TCDMAEN_R {
        TCDMAEN_R::new(((self.bits >> 14) & 0x01) != 0)
    }
    #[doc = "Bit 15 - RXDMAEN"]
    #[inline(always)]
...
impl W {
    ...
    #[doc = "Bit 14 - TCDMAEN"]
    #[inline(always)]
    pub fn tcdmaen(&mut self) -> TCDMAEN_W {
        TCDMAEN_W { w: self }
    }
    #[doc = "Bit 15 - RXDMAEN"]
    #[inline(always)]
