...
#[doc = "Reader of field `SADD1_7`"]
pub type SADD1_7_R = crate::R<u8, u8>;
#[doc = "Write proxy for field `SADD1_7`"]
pub struct SADD1_7_W<'a> {
    w: &'a mut W,
}
impl<'a> SADD1_7_W<'a> {
    #[doc = r"Writes raw bits to the field"]
...
#[doc = "Reader of field `SADD8_9`"]
pub type SADD8_9_R = crate::R<u8, u8>;
#[doc = "Write proxy for field `SADD8_9`"]
pub struct SADD8_9_W<'a> {
    w: &'a mut W,
}
impl<'a> SADD8_9_W<'a> {
    #[doc = r"Writes raw bits to the field"]
...
impl R {
    ...
    #[inline(always)]
    pub fn sadd1_7(&self) -> SADD1_7_R {
        SADD1_7_R::new(((self.bits >> 1) & 0x7f) as u8)
    }
    #[doc = "Bits 8:9 - Slave address bit 8_9"]
    #[inline(always)]
    pub fn sadd8_9(&self) -> SADD8_9_R {
        SADD8_9_R::new(((self.bits >> 8) & 0x03) as u8)
    }
...
impl W {
    ...
    #[doc = "Bits 1:7 - Slave address bit 7_1"]
    #[inline(always)]
    pub fn sadd1_7(&mut self) -> SADD1_7_W {
        SADD1_7_W { w: self }
    }
    #[doc = "Bits 8:9 - Slave address bit 8_9"]
    #[inline(always)]
    pub fn sadd8_9(&mut self) -> SADD8_9_W {
        SADD8_9_W { w: self }
    }
    #[doc = "Bit 10 - Transfer direction"]
    #[inline(always)]
