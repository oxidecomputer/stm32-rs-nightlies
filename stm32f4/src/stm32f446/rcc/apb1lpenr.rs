...
#[doc = "I2CFMP1 clock enable during Sleep mode"]
pub type I2CFMP1LPEN_A = TIM2LPEN_A;
#[doc = "Reader of field `I2CFMP1LPEN`"]
pub type I2CFMP1LPEN_R = crate::R<bool, TIM2LPEN_A>;
...
impl<'a> I2CFMP1LPEN_W<'a> {
    #[doc = r"Writes `variant` to the field"]
    #[inline(always)]
    pub fn variant(self, variant: I2CFMP1LPEN_A) -> &'a mut W {
        {
            self.bit(variant.into())
        }
    }
