...
#[doc = "Compensation cell control register"]
pub mod cmpcr;
#[doc = "I2C_BUFOUT\n\nThis register you can [`read`](crate::generic::Reg::read), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [i2c_bufout](i2c_bufout) module"]
pub type I2C_BUFOUT = crate::Reg<u32, _I2C_BUFOUT>;
#[allow(missing_docs)]
#[doc(hidden)]
pub struct _I2C_BUFOUT;
#[doc = "`read()` method returns [i2c_bufout::R](i2c_bufout::R) reader structure"]
impl crate::Readable for I2C_BUFOUT {}
#[doc = "`write(|w| ..)` method takes [i2c_bufout::W](i2c_bufout::W) writer structure"]
impl crate::Writable for I2C_BUFOUT {}
#[doc = "I2C_BUFOUT"]
pub mod i2c_bufout;
