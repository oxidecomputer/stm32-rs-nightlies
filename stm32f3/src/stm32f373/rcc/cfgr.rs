...
#[doc = "Reader of field `SDPRE`"]
pub type SDPRE_R = crate::R<u8, SDPRE_A>;
impl SDPRE_R {
    #[doc = r"Get enumerated values variant"]
    #[inline(always)]
    pub fn variant(&self) -> crate::Variant<u8, SDPRE_A> {
        use crate::Variant::*;
        match self.bits {
            0 => Val(SDPRE_A::DIV2),
            17 => Val(SDPRE_A::DIV4),
            18 => Val(SDPRE_A::DIV6),
            19 => Val(SDPRE_A::DIV8),
            20 => Val(SDPRE_A::DIV10),
            21 => Val(SDPRE_A::DIV12),
            22 => Val(SDPRE_A::DIV14),
            23 => Val(SDPRE_A::DIV16),
            24 => Val(SDPRE_A::DIV20),
            25 => Val(SDPRE_A::DIV24),
            26 => Val(SDPRE_A::DIV28),
            27 => Val(SDPRE_A::DIV32),
            28 => Val(SDPRE_A::DIV36),
            29 => Val(SDPRE_A::DIV40),
            30 => Val(SDPRE_A::DIV44),
            31 => Val(SDPRE_A::DIV48),
            i => Res(i),
        }
    }
    #[doc = "Checks if the value of the field is `DIV2`"]
...
#[doc = "Write proxy for field `SDPRE`"]
