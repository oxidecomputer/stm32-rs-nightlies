...
impl RegisterBlock {
    ...
    #[doc = "0x24 - counter"]
    #[inline(always)]
    pub fn cnt_alternate5(&self) -> &CNT_ALTERNATE5 {
        unsafe { &*(((self as *const Self) as *const u8).add(36usize) as *const CNT_ALTERNATE5) }
    }
    #[doc = "0x24 - counter"]
    #[inline(always)]
    pub fn cnt_alternate5_mut(&self) -> &mut CNT_ALTERNATE5 {
        unsafe { &mut *(((self as *const Self) as *mut u8).add(36usize) as *mut CNT_ALTERNATE5) }
    }
    #[doc = "0x24 - counter"]
    #[inline(always)]
    pub fn cnt(&self) -> &CNT {
        unsafe { &*(((self as *const Self) as *const u8).add(36usize) as *const CNT) }
    }
    #[doc = "0x24 - counter"]
    #[inline(always)]
    pub fn cnt_mut(&self) -> &mut CNT {
        unsafe { &mut *(((self as *const Self) as *mut u8).add(36usize) as *mut CNT) }
    }
}
...
#[doc = "counter"]
pub mod cnt;
#[doc = "counter\n\nThis register you can [`read`](crate::generic::Reg::read), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [cnt_alternate5](cnt_alternate5) module"]
pub type CNT_ALTERNATE5 = crate::Reg<u32, _CNT_ALTERNATE5>;
#[allow(missing_docs)]
#[doc(hidden)]
pub struct _CNT_ALTERNATE5;
#[doc = "`read()` method returns [cnt_alternate5::R](cnt_alternate5::R) reader structure"]
impl crate::Readable for CNT_ALTERNATE5 {}
#[doc = "`write(|w| ..)` method takes [cnt_alternate5::W](cnt_alternate5::W) writer structure"]
impl crate::Writable for CNT_ALTERNATE5 {}
#[doc = "counter"]
