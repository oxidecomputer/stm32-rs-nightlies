...
pub type SCARCNT_R = crate::R<u8, SCARCNT_A>;
impl SCARCNT_R {
    #[doc = r"Get enumerated values variant"]
    #[inline(always)]
...
impl RXFTCFG_R {
    ...
    pub fn variant(&self) -> crate::Variant<u8, RXFTCFG_A> {
        use crate::Variant::*;
        match self.bits {
            0 => Val(RXFTCFG_A::B_0X0),
            1 => Val(RXFTCFG_A::B_0X1),
            2 => Val(RXFTCFG_A::B_0X2),
            3 => Val(RXFTCFG_A::B_0X3),
            4 => Val(RXFTCFG_A::B_0X4),
            5 => Val(RXFTCFG_A::B_0X5),
            i => Res(i),
        }
    }
    #[doc = "Checks if the value of the field is `B_0X0`"]
...
impl TXFTCFG_R {
    ...
    pub fn variant(&self) -> crate::Variant<u8, TXFTCFG_A> {
        use crate::Variant::*;
        match self.bits {
            0 => Val(TXFTCFG_A::B_0X0),
            1 => Val(TXFTCFG_A::B_0X1),
            2 => Val(TXFTCFG_A::B_0X2),
            3 => Val(TXFTCFG_A::B_0X3),
            4 => Val(TXFTCFG_A::B_0X4),
            5 => Val(TXFTCFG_A::B_0X5),
            i => Res(i),
        }
    }
    #[doc = "Checks if the value of the field is `B_0X0`"]
