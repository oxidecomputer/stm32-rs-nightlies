#[doc = "Writer for register TIM1_EGR"]
pub type W = crate::W<u32, super::TIM1_EGR>;
#[doc = "Register TIM1_EGR `reset()`'s with value 0"]
impl crate::ResetValue for super::TIM1_EGR {
    type Type = u32;
    #[inline(always)]
