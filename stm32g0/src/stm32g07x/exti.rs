...
impl RegisterBlock {
    #[doc = "0x80 - EXTI CPU wakeup with event mask register"]
    #[inline(always)]
    pub fn emr1(&self) -> &EMR1 {
        unsafe { &*(((self as *const Self) as *const u8).add(128usize) as *const EMR1) }
    }
    #[doc = "0x80 - EXTI CPU wakeup with event mask register"]
    #[inline(always)]
    pub fn emr1_mut(&self) -> &mut EMR1 {
        unsafe { &mut *(((self as *const Self) as *mut u8).add(128usize) as *mut EMR1) }
    }
    #[doc = "0x80 - EXTI CPU wakeup with interrupt mask register"]
    #[inline(always)]
    pub fn imr1(&self) -> &IMR1 {
        unsafe { &*(((self as *const Self) as *const u8).add(128usize) as *const IMR1) }
    }
    #[doc = "0x80 - EXTI CPU wakeup with interrupt mask register"]
    #[inline(always)]
    pub fn imr1_mut(&self) -> &mut IMR1 {
        unsafe { &mut *(((self as *const Self) as *mut u8).add(128usize) as *mut IMR1) }
    }
}
