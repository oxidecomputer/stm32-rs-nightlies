#[doc = "Reader of register AES_SUSP2R"]
pub type R = crate::R<u32, super::AES_SUSP2R>;
#[doc = "Writer for register AES_SUSP2R"]
pub type W = crate::W<u32, super::AES_SUSP2R>;
#[doc = "Register AES_SUSP2R `reset()`'s with value 0"]
impl crate::ResetValue for super::AES_SUSP2R {
    type Type = u32;
    #[inline(always)]
