#[doc = "Reader of register TIM1_CNT"]
pub type R = crate::R<u32, super::TIM1_CNT>;
#[doc = "Writer for register TIM1_CNT"]
pub type W = crate::W<u32, super::TIM1_CNT>;
#[doc = "Register TIM1_CNT `reset()`'s with value 0"]
impl crate::ResetValue for super::TIM1_CNT {
    type Type = u32;
    #[inline(always)]
