#[doc = "Reader of register ADC_CFGR1"]
pub type R = crate::R<u32, super::ADC_CFGR1>;
#[doc = "Writer for register ADC_CFGR1"]
pub type W = crate::W<u32, super::ADC_CFGR1>;
#[doc = "Register ADC_CFGR1 `reset()`'s with value 0"]
impl crate::ResetValue for super::ADC_CFGR1 {
    type Type = u32;
    #[inline(always)]
...
pub type CHSELRMOD_R = crate::R<bool, CHSELRMOD_A>;
impl CHSELRMOD_R {
    #[doc = r"Get enumerated values variant"]
    #[inline(always)]
...
pub type AWD1CH_R = crate::R<u8, AWD1CH_A>;
impl AWD1CH_R {
    #[doc = r"Get enumerated values variant"]
    #[inline(always)]
    pub fn variant(&self) -> crate::Variant<u8, AWD1CH_A> {
        use crate::Variant::*;
        match self.bits {
            0 => Val(AWD1CH_A::B_0X0),
            1 => Val(AWD1CH_A::B_0X1),
            17 => Val(AWD1CH_A::B_0X11),
            18 => Val(AWD1CH_A::B_0X12),
            i => Res(i),
        }
    }
    #[doc = "Checks if the value of the field is `B_0X0`"]
