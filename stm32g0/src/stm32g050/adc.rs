...
pub struct RegisterBlock {
    ...
    _reserved_8_adc_chselrmod: [u8; 4usize],
...
impl RegisterBlock {
    ...
    #[inline(always)]
    pub fn adc_chselrmod1(&self) -> &ADC_CHSELRMOD1 {
        unsafe { &*(((self as *const Self) as *const u8).add(40usize) as *const ADC_CHSELRMOD1) }
    }
    #[doc = "0x28 - ADC channel selection register"]
    #[inline(always)]
    pub fn adc_chselrmod1_mut(&self) -> &mut ADC_CHSELRMOD1 {
        unsafe { &mut *(((self as *const Self) as *mut u8).add(40usize) as *mut ADC_CHSELRMOD1) }
    }
    #[doc = "0x28 - ADC channel selection register"]
    #[inline(always)]
    pub fn adc_chselrmod0(&self) -> &ADC_CHSELRMOD0 {
        unsafe { &*(((self as *const Self) as *const u8).add(40usize) as *const ADC_CHSELRMOD0) }
    }
    #[doc = "0x28 - ADC channel selection register"]
    #[inline(always)]
    pub fn adc_chselrmod0_mut(&self) -> &mut ADC_CHSELRMOD0 {
        unsafe { &mut *(((self as *const Self) as *mut u8).add(40usize) as *mut ADC_CHSELRMOD0) }
    }
}
...
#[doc = "ADC watchdog threshold register"]
pub mod adc_awd2tr;
#[doc = "ADC channel selection register\n\nThis register you can [`read`](crate::generic::Reg::read), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [adc_chselrmod0](adc_chselrmod0) module"]
pub type ADC_CHSELRMOD0 = crate::Reg<u32, _ADC_CHSELRMOD0>;
#[allow(missing_docs)]
#[doc(hidden)]
pub struct _ADC_CHSELRMOD0;
#[doc = "`read()` method returns [adc_chselrmod0::R](adc_chselrmod0::R) reader structure"]
impl crate::Readable for ADC_CHSELRMOD0 {}
#[doc = "`write(|w| ..)` method takes [adc_chselrmod0::W](adc_chselrmod0::W) writer structure"]
impl crate::Writable for ADC_CHSELRMOD0 {}
#[doc = "ADC channel selection register"]
pub mod adc_chselrmod0;
#[doc = "ADC channel selection register\n\nThis register you can [`read`](crate::generic::Reg::read), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [adc_chselrmod1](adc_chselrmod1) module"]
pub type ADC_CHSELRMOD1 = crate::Reg<u32, _ADC_CHSELRMOD1>;
#[allow(missing_docs)]
#[doc(hidden)]
pub struct _ADC_CHSELRMOD1;
#[doc = "`read()` method returns [adc_chselrmod1::R](adc_chselrmod1::R) reader structure"]
impl crate::Readable for ADC_CHSELRMOD1 {}
#[doc = "`write(|w| ..)` method takes [adc_chselrmod1::W](adc_chselrmod1::W) writer structure"]
impl crate::Writable for ADC_CHSELRMOD1 {}
#[doc = "ADC channel selection register"]
