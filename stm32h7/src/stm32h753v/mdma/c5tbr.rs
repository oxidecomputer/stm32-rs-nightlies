#[doc = "Reader of register C5TBR"]
pub type R = crate::R<u32, super::C5TBR>;
#[doc = "Writer for register C5TBR"]
pub type W = crate::W<u32, super::C5TBR>;
#[doc = "Register C5TBR `reset()`'s with value 0"]
impl crate::ResetValue for super::C5TBR {
    type Type = u32;
    #[inline(always)]
