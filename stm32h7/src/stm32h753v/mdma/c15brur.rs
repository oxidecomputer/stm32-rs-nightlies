#[doc = "Reader of register C15BRUR"]
pub type R = crate::R<u32, super::C15BRUR>;
#[doc = "Writer for register C15BRUR"]
pub type W = crate::W<u32, super::C15BRUR>;
#[doc = "Register C15BRUR `reset()`'s with value 0"]
impl crate::ResetValue for super::C15BRUR {
    type Type = u32;
    #[inline(always)]
