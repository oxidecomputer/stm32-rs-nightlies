#[doc = "Reader of register C11BNDTR"]
pub type R = crate::R<u32, super::C11BNDTR>;
#[doc = "Writer for register C11BNDTR"]
pub type W = crate::W<u32, super::C11BNDTR>;
#[doc = "Register C11BNDTR `reset()`'s with value 0"]
impl crate::ResetValue for super::C11BNDTR {
    type Type = u32;
    #[inline(always)]
