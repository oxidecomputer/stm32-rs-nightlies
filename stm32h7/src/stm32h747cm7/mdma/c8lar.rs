#[doc = "Reader of register C8LAR"]
pub type R = crate::R<u32, super::C8LAR>;
#[doc = "Writer for register C8LAR"]
pub type W = crate::W<u32, super::C8LAR>;
#[doc = "Register C8LAR `reset()`'s with value 0"]
impl crate::ResetValue for super::C8LAR {
    type Type = u32;
    #[inline(always)]
