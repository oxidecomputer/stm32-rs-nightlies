#[doc = "Reader of register C12BRUR"]
pub type R = crate::R<u32, super::C12BRUR>;
#[doc = "Writer for register C12BRUR"]
pub type W = crate::W<u32, super::C12BRUR>;
#[doc = "Register C12BRUR `reset()`'s with value 0"]
impl crate::ResetValue for super::C12BRUR {
    type Type = u32;
    #[inline(always)]
