#[doc = "Reader of register C12TBR"]
pub type R = crate::R<u32, super::C12TBR>;
#[doc = "Writer for register C12TBR"]
pub type W = crate::W<u32, super::C12TBR>;
#[doc = "Register C12TBR `reset()`'s with value 0"]
impl crate::ResetValue for super::C12TBR {
    type Type = u32;
    #[inline(always)]
