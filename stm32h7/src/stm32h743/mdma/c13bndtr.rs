#[doc = "Reader of register C13BNDTR"]
pub type R = crate::R<u32, super::C13BNDTR>;
#[doc = "Writer for register C13BNDTR"]
pub type W = crate::W<u32, super::C13BNDTR>;
#[doc = "Register C13BNDTR `reset()`'s with value 0"]
impl crate::ResetValue for super::C13BNDTR {
    type Type = u32;
    #[inline(always)]
