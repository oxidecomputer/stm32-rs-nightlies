#[doc = "Reader of register C9TBR"]
pub type R = crate::R<u32, super::C9TBR>;
#[doc = "Writer for register C9TBR"]
pub type W = crate::W<u32, super::C9TBR>;
#[doc = "Register C9TBR `reset()`'s with value 0"]
impl crate::ResetValue for super::C9TBR {
    type Type = u32;
    #[inline(always)]
