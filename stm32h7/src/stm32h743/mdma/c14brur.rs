#[doc = "Reader of register C14BRUR"]
pub type R = crate::R<u32, super::C14BRUR>;
#[doc = "Writer for register C14BRUR"]
pub type W = crate::W<u32, super::C14BRUR>;
#[doc = "Register C14BRUR `reset()`'s with value 0"]
impl crate::ResetValue for super::C14BRUR {
    type Type = u32;
    #[inline(always)]
