#[doc = "Reader of register C3LAR"]
pub type R = crate::R<u32, super::C3LAR>;
#[doc = "Writer for register C3LAR"]
pub type W = crate::W<u32, super::C3LAR>;
#[doc = "Register C3LAR `reset()`'s with value 0"]
impl crate::ResetValue for super::C3LAR {
    type Type = u32;
    #[inline(always)]
