#[doc = "Reader of register C15BNDTR"]
pub type R = crate::R<u32, super::C15BNDTR>;
#[doc = "Writer for register C15BNDTR"]
pub type W = crate::W<u32, super::C15BNDTR>;
#[doc = "Register C15BNDTR `reset()`'s with value 0"]
impl crate::ResetValue for super::C15BNDTR {
    type Type = u32;
    #[inline(always)]
