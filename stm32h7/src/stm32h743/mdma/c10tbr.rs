#[doc = "Reader of register C10TBR"]
pub type R = crate::R<u32, super::C10TBR>;
#[doc = "Writer for register C10TBR"]
pub type W = crate::W<u32, super::C10TBR>;
#[doc = "Register C10TBR `reset()`'s with value 0"]
impl crate::ResetValue for super::C10TBR {
    type Type = u32;
    #[inline(always)]
