#[doc = "Reader of register C8TBR"]
pub type R = crate::R<u32, super::C8TBR>;
#[doc = "Writer for register C8TBR"]
pub type W = crate::W<u32, super::C8TBR>;
#[doc = "Register C8TBR `reset()`'s with value 0"]
impl crate::ResetValue for super::C8TBR {
    type Type = u32;
    #[inline(always)]
