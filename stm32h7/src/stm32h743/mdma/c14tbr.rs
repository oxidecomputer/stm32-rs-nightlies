#[doc = "Reader of register C14TBR"]
pub type R = crate::R<u32, super::C14TBR>;
#[doc = "Writer for register C14TBR"]
pub type W = crate::W<u32, super::C14TBR>;
#[doc = "Register C14TBR `reset()`'s with value 0"]
impl crate::ResetValue for super::C14TBR {
    type Type = u32;
    #[inline(always)]
