#[doc = "Reader of register C10BRUR"]
pub type R = crate::R<u32, super::C10BRUR>;
#[doc = "Writer for register C10BRUR"]
pub type W = crate::W<u32, super::C10BRUR>;
#[doc = "Register C10BRUR `reset()`'s with value 0"]
impl crate::ResetValue for super::C10BRUR {
    type Type = u32;
    #[inline(always)]
