#[doc = "Reader of register C2LAR"]
pub type R = crate::R<u32, super::C2LAR>;
#[doc = "Writer for register C2LAR"]
pub type W = crate::W<u32, super::C2LAR>;
#[doc = "Register C2LAR `reset()`'s with value 0"]
impl crate::ResetValue for super::C2LAR {
    type Type = u32;
    #[inline(always)]
