#[doc = "Reader of register C11BRUR"]
pub type R = crate::R<u32, super::C11BRUR>;
#[doc = "Writer for register C11BRUR"]
pub type W = crate::W<u32, super::C11BRUR>;
#[doc = "Register C11BRUR `reset()`'s with value 0"]
impl crate::ResetValue for super::C11BRUR {
    type Type = u32;
    #[inline(always)]
