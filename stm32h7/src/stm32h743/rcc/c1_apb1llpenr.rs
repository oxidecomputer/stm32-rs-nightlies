#[doc = "Reader of register C1_APB1LLPENR"]
pub type R = crate::R<u32, super::C1_APB1LLPENR>;
#[doc = "Writer for register C1_APB1LLPENR"]
pub type W = crate::W<u32, super::C1_APB1LLPENR>;
#[doc = "Register C1_APB1LLPENR `reset()`'s with value 0"]
impl crate::ResetValue for super::C1_APB1LLPENR {
    type Type = u32;
    #[inline(always)]
...
#[doc = "USART7 Peripheral Clocks Enable During CSleep Mode"]
pub type USART7LPEN_A = TIM2LPEN_A;
#[doc = "Reader of field `USART7LPEN`"]
pub type USART7LPEN_R = crate::R<bool, TIM2LPEN_A>;
#[doc = "Write proxy for field `USART7LPEN`"]
pub struct USART7LPEN_W<'a> {
    w: &'a mut W,
}
impl<'a> USART7LPEN_W<'a> {
    #[doc = r"Writes `variant` to the field"]
    #[inline(always)]
    pub fn variant(self, variant: USART7LPEN_A) -> &'a mut W {
        {
            self.bit(variant.into())
        }
    }
...
#[doc = "USART8 Peripheral Clocks Enable During CSleep Mode"]
pub type USART8LPEN_A = TIM2LPEN_A;
#[doc = "Reader of field `USART8LPEN`"]
pub type USART8LPEN_R = crate::R<bool, TIM2LPEN_A>;
#[doc = "Write proxy for field `USART8LPEN`"]
pub struct USART8LPEN_W<'a> {
    w: &'a mut W,
}
impl<'a> USART8LPEN_W<'a> {
    #[doc = r"Writes `variant` to the field"]
    #[inline(always)]
    pub fn variant(self, variant: USART8LPEN_A) -> &'a mut W {
        {
            self.bit(variant.into())
        }
    }
...
impl W {
    ...
    #[doc = "Bit 30 - USART7 Peripheral Clocks Enable During CSleep Mode"]
    #[inline(always)]
    pub fn usart7lpen(&mut self) -> USART7LPEN_W {
        USART7LPEN_W { w: self }
    }
    #[doc = "Bit 31 - USART8 Peripheral Clocks Enable During CSleep Mode"]
    #[inline(always)]
    pub fn usart8lpen(&mut self) -> USART8LPEN_W {
        USART8LPEN_W { w: self }
    }
}
