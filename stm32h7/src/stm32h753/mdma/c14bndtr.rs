#[doc = "Reader of register C14BNDTR"]
pub type R = crate::R<u32, super::C14BNDTR>;
#[doc = "Writer for register C14BNDTR"]
pub type W = crate::W<u32, super::C14BNDTR>;
#[doc = "Register C14BNDTR `reset()`'s with value 0"]
impl crate::ResetValue for super::C14BNDTR {
    type Type = u32;
    #[inline(always)]
