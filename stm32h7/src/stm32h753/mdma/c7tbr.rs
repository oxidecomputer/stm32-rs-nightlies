#[doc = "Reader of register C7TBR"]
pub type R = crate::R<u32, super::C7TBR>;
#[doc = "Writer for register C7TBR"]
pub type W = crate::W<u32, super::C7TBR>;
#[doc = "Register C7TBR `reset()`'s with value 0"]
impl crate::ResetValue for super::C7TBR {
    type Type = u32;
    #[inline(always)]
