#[doc = "Reader of register C9LAR"]
pub type R = crate::R<u32, super::C9LAR>;
#[doc = "Writer for register C9LAR"]
pub type W = crate::W<u32, super::C9LAR>;
#[doc = "Register C9LAR `reset()`'s with value 0"]
impl crate::ResetValue for super::C9LAR {
    type Type = u32;
    #[inline(always)]
