#[doc = "Reader of register BDMA_CNDTR0"]
pub type R = crate::R<u32, super::BDMA_CNDTR0>;
#[doc = "Writer for register BDMA_CNDTR0"]
pub type W = crate::W<u32, super::BDMA_CNDTR0>;
#[doc = "Register BDMA_CNDTR0 `reset()`'s with value 0"]
impl crate::ResetValue for super::BDMA_CNDTR0 {
    type Type = u32;
    #[inline(always)]
