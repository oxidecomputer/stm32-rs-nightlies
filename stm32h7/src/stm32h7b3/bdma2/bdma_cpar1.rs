#[doc = "Reader of register BDMA_CPAR1"]
pub type R = crate::R<u32, super::BDMA_CPAR1>;
#[doc = "Writer for register BDMA_CPAR1"]
pub type W = crate::W<u32, super::BDMA_CPAR1>;
#[doc = "Register BDMA_CPAR1 `reset()`'s with value 0"]
impl crate::ResetValue for super::BDMA_CPAR1 {
    type Type = u32;
    #[inline(always)]
