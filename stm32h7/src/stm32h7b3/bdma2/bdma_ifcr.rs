#[doc = "Writer for register BDMA_IFCR"]
pub type W = crate::W<u32, super::BDMA_IFCR>;
#[doc = "Register BDMA_IFCR `reset()`'s with value 0"]
impl crate::ResetValue for super::BDMA_IFCR {
    type Type = u32;
    #[inline(always)]
