#[doc = "Reader of register BDMA_CM0AR4"]
pub type R = crate::R<u32, super::BDMA_CM0AR4>;
#[doc = "Writer for register BDMA_CM0AR4"]
pub type W = crate::W<u32, super::BDMA_CM0AR4>;
#[doc = "Register BDMA_CM0AR4 `reset()`'s with value 0"]
impl crate::ResetValue for super::BDMA_CM0AR4 {
    type Type = u32;
    #[inline(always)]
