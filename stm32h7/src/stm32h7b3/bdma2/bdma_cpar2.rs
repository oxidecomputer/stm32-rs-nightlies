#[doc = "Reader of register BDMA_CPAR2"]
pub type R = crate::R<u32, super::BDMA_CPAR2>;
#[doc = "Writer for register BDMA_CPAR2"]
pub type W = crate::W<u32, super::BDMA_CPAR2>;
#[doc = "Register BDMA_CPAR2 `reset()`'s with value 0"]
impl crate::ResetValue for super::BDMA_CPAR2 {
    type Type = u32;
    #[inline(always)]
