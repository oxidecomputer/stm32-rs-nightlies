#[doc = "Reader of register BDMA_CNDTR6"]
pub type R = crate::R<u32, super::BDMA_CNDTR6>;
#[doc = "Writer for register BDMA_CNDTR6"]
pub type W = crate::W<u32, super::BDMA_CNDTR6>;
#[doc = "Register BDMA_CNDTR6 `reset()`'s with value 0"]
impl crate::ResetValue for super::BDMA_CNDTR6 {
    type Type = u32;
    #[inline(always)]
