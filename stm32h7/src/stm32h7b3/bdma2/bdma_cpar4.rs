#[doc = "Reader of register BDMA_CPAR4"]
pub type R = crate::R<u32, super::BDMA_CPAR4>;
#[doc = "Writer for register BDMA_CPAR4"]
pub type W = crate::W<u32, super::BDMA_CPAR4>;
#[doc = "Register BDMA_CPAR4 `reset()`'s with value 0"]
impl crate::ResetValue for super::BDMA_CPAR4 {
    type Type = u32;
    #[inline(always)]
