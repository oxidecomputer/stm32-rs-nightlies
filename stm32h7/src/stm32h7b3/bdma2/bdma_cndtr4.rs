#[doc = "Reader of register BDMA_CNDTR4"]
pub type R = crate::R<u32, super::BDMA_CNDTR4>;
#[doc = "Writer for register BDMA_CNDTR4"]
pub type W = crate::W<u32, super::BDMA_CNDTR4>;
#[doc = "Register BDMA_CNDTR4 `reset()`'s with value 0"]
impl crate::ResetValue for super::BDMA_CNDTR4 {
    type Type = u32;
    #[inline(always)]
