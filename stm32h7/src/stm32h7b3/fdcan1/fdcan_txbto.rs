...
#[doc = "Writer for register FDCAN_TXBTO"]
pub type W = crate::W<u32, super::FDCAN_TXBTO>;
#[doc = "Register FDCAN_TXBTO `reset()`'s with value 0"]
impl crate::ResetValue for super::FDCAN_TXBTO {
    type Type = u32;
    #[inline(always)]
