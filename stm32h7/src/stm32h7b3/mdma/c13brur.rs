#[doc = "Reader of register C13BRUR"]
pub type R = crate::R<u32, super::C13BRUR>;
#[doc = "Writer for register C13BRUR"]
pub type W = crate::W<u32, super::C13BRUR>;
#[doc = "Register C13BRUR `reset()`'s with value 0"]
impl crate::ResetValue for super::C13BRUR {
    type Type = u32;
    #[inline(always)]
