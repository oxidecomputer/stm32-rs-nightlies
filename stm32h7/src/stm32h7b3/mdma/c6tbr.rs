#[doc = "Reader of register C6TBR"]
pub type R = crate::R<u32, super::C6TBR>;
#[doc = "Writer for register C6TBR"]
pub type W = crate::W<u32, super::C6TBR>;
#[doc = "Register C6TBR `reset()`'s with value 0"]
impl crate::ResetValue for super::C6TBR {
    type Type = u32;
    #[inline(always)]
