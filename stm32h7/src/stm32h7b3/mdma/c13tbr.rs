#[doc = "Reader of register C13TBR"]
pub type R = crate::R<u32, super::C13TBR>;
#[doc = "Writer for register C13TBR"]
pub type W = crate::W<u32, super::C13TBR>;
#[doc = "Register C13TBR `reset()`'s with value 0"]
impl crate::ResetValue for super::C13TBR {
    type Type = u32;
    #[inline(always)]
