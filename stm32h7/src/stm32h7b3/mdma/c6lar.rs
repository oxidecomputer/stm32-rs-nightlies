#[doc = "Reader of register C6LAR"]
pub type R = crate::R<u32, super::C6LAR>;
#[doc = "Writer for register C6LAR"]
pub type W = crate::W<u32, super::C6LAR>;
#[doc = "Register C6LAR `reset()`'s with value 0"]
impl crate::ResetValue for super::C6LAR {
    type Type = u32;
    #[inline(always)]
