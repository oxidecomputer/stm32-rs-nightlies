...
#[doc = "Writer for register FDCAN_TXEFS"]
pub type W = crate::W<u32, super::FDCAN_TXEFS>;
#[doc = "Register FDCAN_TXEFS `reset()`'s with value 0"]
impl crate::ResetValue for super::FDCAN_TXEFS {
    type Type = u32;
    #[inline(always)]
