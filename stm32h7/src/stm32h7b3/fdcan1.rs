...
impl RegisterBlock {
    ...
    #[inline(always)]
    pub fn fdcan_ttts(&self) -> &FDCAN_TTTS {
        unsafe { &*(((self as *const Self) as *const u8).add(256usize) as *const FDCAN_TTTS) }
    }
    #[doc = "0x100 - FDCAN TT Trigger Select Register"]
    #[inline(always)]
    pub fn fdcan_ttts_mut(&self) -> &mut FDCAN_TTTS {
        unsafe { &mut *(((self as *const Self) as *mut u8).add(256usize) as *mut FDCAN_TTTS) }
    }
    #[doc = "0x100 - FDCAN TT Trigger Memory Configuration Register"]
    #[inline(always)]
    pub fn fdcan_tttmc(&self) -> &FDCAN_TTTMC {
        unsafe { &*(((self as *const Self) as *const u8).add(256usize) as *const FDCAN_TTTMC) }
    }
    #[doc = "0x100 - FDCAN TT Trigger Memory Configuration Register"]
    #[inline(always)]
    pub fn fdcan_tttmc_mut(&self) -> &mut FDCAN_TTTMC {
        unsafe { &mut *(((self as *const Self) as *mut u8).add(256usize) as *mut FDCAN_TTTMC) }
    }
}
