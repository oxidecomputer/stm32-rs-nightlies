#[doc = "Reader of register C1LAR"]
pub type R = crate::R<u32, super::C1LAR>;
#[doc = "Writer for register C1LAR"]
pub type W = crate::W<u32, super::C1LAR>;
#[doc = "Register C1LAR `reset()`'s with value 0"]
impl crate::ResetValue for super::C1LAR {
    type Type = u32;
    #[inline(always)]
