#[doc = "Reader of register C5LAR"]
pub type R = crate::R<u32, super::C5LAR>;
#[doc = "Writer for register C5LAR"]
pub type W = crate::W<u32, super::C5LAR>;
#[doc = "Register C5LAR `reset()`'s with value 0"]
impl crate::ResetValue for super::C5LAR {
    type Type = u32;
    #[inline(always)]
