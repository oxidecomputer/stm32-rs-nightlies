#[doc = "Reader of register C4LAR"]
pub type R = crate::R<u32, super::C4LAR>;
#[doc = "Writer for register C4LAR"]
pub type W = crate::W<u32, super::C4LAR>;
#[doc = "Register C4LAR `reset()`'s with value 0"]
impl crate::ResetValue for super::C4LAR {
    type Type = u32;
    #[inline(always)]
