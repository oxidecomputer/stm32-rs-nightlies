#[doc = "Reader of register C14CR"]
pub type R = crate::R<u32, super::C14CR>;
#[doc = "Writer for register C14CR"]
pub type W = crate::W<u32, super::C14CR>;
#[doc = "Register C14CR `reset()`'s with value 0"]
impl crate::ResetValue for super::C14CR {
    type Type = u32;
    #[inline(always)]
