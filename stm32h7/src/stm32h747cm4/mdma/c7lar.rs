#[doc = "Reader of register C7LAR"]
pub type R = crate::R<u32, super::C7LAR>;
#[doc = "Writer for register C7LAR"]
pub type W = crate::W<u32, super::C7LAR>;
#[doc = "Register C7LAR `reset()`'s with value 0"]
impl crate::ResetValue for super::C7LAR {
    type Type = u32;
    #[inline(always)]
