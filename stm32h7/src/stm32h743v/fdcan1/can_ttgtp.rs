#[doc = "Reader of register CAN_TTGTP"]
pub type R = crate::R<u32, super::CAN_TTGTP>;
#[doc = "Writer for register CAN_TTGTP"]
pub type W = crate::W<u32, super::CAN_TTGTP>;
#[doc = "Register CAN_TTGTP `reset()`'s with value 0"]
impl crate::ResetValue for super::CAN_TTGTP {
    type Type = u32;
    #[inline(always)]
