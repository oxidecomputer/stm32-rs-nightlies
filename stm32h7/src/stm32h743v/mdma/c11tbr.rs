#[doc = "Reader of register C11TBR"]
pub type R = crate::R<u32, super::C11TBR>;
#[doc = "Writer for register C11TBR"]
pub type W = crate::W<u32, super::C11TBR>;
#[doc = "Register C11TBR `reset()`'s with value 0"]
impl crate::ResetValue for super::C11TBR {
    type Type = u32;
    #[inline(always)]
