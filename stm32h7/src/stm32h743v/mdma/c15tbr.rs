#[doc = "Reader of register C15TBR"]
pub type R = crate::R<u32, super::C15TBR>;
#[doc = "Writer for register C15TBR"]
pub type W = crate::W<u32, super::C15TBR>;
#[doc = "Register C15TBR `reset()`'s with value 0"]
impl crate::ResetValue for super::C15TBR {
    type Type = u32;
    #[inline(always)]
