#[doc = "Reader of register C10BNDTR"]
pub type R = crate::R<u32, super::C10BNDTR>;
#[doc = "Writer for register C10BNDTR"]
pub type W = crate::W<u32, super::C10BNDTR>;
#[doc = "Register C10BNDTR `reset()`'s with value 0"]
impl crate::ResetValue for super::C10BNDTR {
    type Type = u32;
    #[inline(always)]
