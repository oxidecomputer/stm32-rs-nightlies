#[doc = "Reader of register C4TBR"]
pub type R = crate::R<u32, super::C4TBR>;
#[doc = "Writer for register C4TBR"]
pub type W = crate::W<u32, super::C4TBR>;
#[doc = "Register C4TBR `reset()`'s with value 0"]
impl crate::ResetValue for super::C4TBR {
    type Type = u32;
    #[inline(always)]
