...
pub type TIM8RST_A = SYSCFGRST_A;
#[doc = "Reader of field `TIM8RST`"]
pub type TIM8RST_R = crate::R<bool, SYSCFGRST_A>;
...
#[doc = "Timer 20 reset"]
pub type TIM20RST_A = SYSCFGRST_A;
#[doc = "Reader of field `TIM20RST`"]
pub type TIM20RST_R = crate::R<bool, SYSCFGRST_A>;
...
impl<'a> TIM20RST_W<'a> {
    #[doc = r"Writes `variant` to the field"]
    #[inline(always)]
    pub fn variant(self, variant: TIM20RST_A) -> &'a mut W {
        {
            self.bit(variant.into())
        }
    }
...
pub type SAI1RST_A = SYSCFGRST_A;
#[doc = "Reader of field `SAI1RST`"]
pub type SAI1RST_R = crate::R<bool, SYSCFGRST_A>;
...
#[doc = "HRTIMER reset"]
pub type HRTIM1RST_A = SYSCFGRST_A;
#[doc = "Reader of field `HRTIM1RST`"]
pub type HRTIM1RST_R = crate::R<bool, SYSCFGRST_A>;
...
impl<'a> HRTIM1RST_W<'a> {
    #[doc = r"Writes `variant` to the field"]
    #[inline(always)]
    pub fn variant(self, variant: HRTIM1RST_A) -> &'a mut W {
        {
            self.bit(variant.into())
        }
    }
